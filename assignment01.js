...
wss.on('connection', function (ws) { // start of wss code
    ...
    switch (value) {
        ...
        break;
        case "9":
            board.digitalWrite(8, board.HIGH); // write high on pin
            board.digitalWrite(9, board.HIGH); // write high on pin
            board.digitalWrite(10, board.HIGH); // write high on pin
            board.digitalWrite(13, board.HIGH); // write high on pin
        break;
        case "8":
            board.digitalWrite(8, board.LOW); // write low on pin
            board.digitalWrite(9, board.LOW); // write low on pin
            board.digitalWrite(10, board.LOW); // write low on pin
